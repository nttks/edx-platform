...
##### TRANSCRIPTS BACKUP S3 SETTINGS #####
TRANSCRIPTS_BACKUP_BUCKET_NAME = ENV_TOKENS.get('TRANSCRIPTS_BACKUP_BUCKET_NAME')
TRANSCRIPTS_BACKUP_DIR = ENV_TOKENS.get('TRANSCRIPTS_BACKUP_DIR')
TRANSCRIPTS_COMMAND_OUTPUT = ENV_TOKENS.get('TRANSCRIPTS_COMMAND_OUTPUT')
...
##### UPLOAD COURSE LIST#####
TOP_PAGE_BUCKET_NAME = AUTH_TOKENS.get('TOP_PAGE_BUCKET_NAME')

##### Settings for Biz #####
from biz.envs.aws import BIZ_SECRET_KEY
...
GA_OPERATION_COURSE_ID_PATTERN = r'(course-v1:[^/+]+(/|\+)[^/+]+(/|\+)[^/+]+)$'
GA_OPERATION_LIBRARY_KEY_PATTERN = r'(library-v1:[^/+]+\+[^/+]+)$'
