...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ContractTaskHistory'
        db.create_table('ga_contract_operation_contracttaskhistory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('contract', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ga_contract.Contract'])),
            ('task_id', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_index=True)),
            ('requester', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('ga_contract_operation', ['ContractTaskHistory'])

        # Adding model 'ContractTaskTarget'
        db.create_table('ga_contract_operation_contracttasktarget', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('history', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ga_contract_operation.ContractTaskHistory'])),
            ('register', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ga_invitation.ContractRegister'])),
            ('completed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('ga_contract_operation', ['ContractTaskTarget'])

        # Adding unique constraint on 'ContractTaskTarget', fields ['history', 'register']
        db.create_unique('ga_contract_operation_contracttasktarget', ['history_id', 'register_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'ContractTaskTarget', fields ['history', 'register']
        db.delete_unique('ga_contract_operation_contracttasktarget', ['history_id', 'register_id'])

        # Deleting model 'ContractTaskHistory'
        db.delete_table('ga_contract_operation_contracttaskhistory')

        # Deleting model 'ContractTaskTarget'
        db.delete_table('ga_contract_operation_contracttasktarget')
