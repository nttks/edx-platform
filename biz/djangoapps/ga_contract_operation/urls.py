...
urlpatterns = patterns(
    ...
    url(r'^students/students_download$', 'students_students_download', name='students_students_download'),
    url(r'^students/search_students_ajax$', 'students_search_students_ajax', name='students_search_students_ajax'),
    url(r'^register_students$', 'register_students', name='register_students'),
    url(r'^register_students/register_additional_info$', 'register_additional_info_ajax',
        name='register_additional_info_ajax'),
    url(r'^register_students/edit_additional_info$', 'edit_additional_info_ajax', name='edit_additional_info_ajax'),
    url(r'^register_students/delete_additional_info$', 'delete_additional_info_ajax',
        name='delete_additional_info_ajax'),
    url(r'^register_students/update_additional_info$', 'update_additional_info_ajax',
        name='update_additional_info_ajax'),
    ...
    url(r'^register_students/template_download$', 'register_students_template_download',
        name='register_students_template_download'),
    url(r'^register_students_csv_ajax$', 'register_students_csv_ajax', name='register_students_csv_ajax'),
    url(r'^register_students_new_ajax$', 'register_students_new_ajax', name='register_students_new_ajax'),
    url(r'^register_students_list_ajax$', 'register_students_list_ajax', name='register_students_list_ajax'),
    url(r'^register_students_search_students_ajax$', 'register_students_search_students_ajax',
        name='register_students_search_students_ajax'),
)
