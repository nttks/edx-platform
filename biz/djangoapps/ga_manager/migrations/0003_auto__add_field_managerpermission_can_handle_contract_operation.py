...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ManagerPermission.can_handle_contract_operation'
        db.add_column('ga_manager_managerpermission', 'can_handle_contract_operation',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ManagerPermission.can_handle_contract_operation'
        db.delete_column('ga_manager_managerpermission', 'can_handle_contract_operation')
    ...
    models = {
        ...
        'ga_manager.managerpermission': {
            ...
            'can_handle_contract_operation': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
