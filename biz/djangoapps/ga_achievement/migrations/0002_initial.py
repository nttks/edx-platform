...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PlaybackBatchStatus'
        db.create_table('ga_achievement_playbackbatchstatus', (
        ...
        db.send_create_signal('ga_achievement', ['PlaybackBatchStatus'])


    def backwards(self, orm):
        # Deleting model 'PlaybackBatchStatus'
        db.delete_table('ga_achievement_playbackbatchstatus')
    ...
    models = {
        ...
        'ga_achievement.playbackbatchstatus': {
            'Meta': {'object_name': 'PlaybackBatchStatus'},
