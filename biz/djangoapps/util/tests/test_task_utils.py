...
from biz.djangoapps.gx_member.tasks import TASKS as MEMBER_TASKS, MEMBER_REGISTER
...
class TaskUtilsTest(BizTestBase):
    ...
    def _get_key_model_and_task_id(self, task_type):
        if task_type in MEMBER_TASKS.keys():
    ...
    @ddt.data(PERSONALINFO_MASK, STUDENT_REGISTER, STUDENT_UNREGISTER, ADDITIONALINFO_UPDATE, MEMBER_REGISTER)
