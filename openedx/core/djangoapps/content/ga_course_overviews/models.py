...
class CourseOverviewExtra(models.Model):
    ...
    def create(cls, course, overview):
        cls(
            ...
            course_category_order=course.course_category_order or None,
            course_category2=course.course_category2,
            course_category_order2=course.course_category_order2 or None,
            course_order=course.course_order or None,
