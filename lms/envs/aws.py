...
# Discussion AWS settings
DISCUSSION_IMAGE_BACKEND_AWS_BUCKET_NAME = ENV_TOKENS.get('DISCUSSION_IMAGE_BACKEND_AWS_BUCKET_NAME', None)
DISCUSSION_IMAGE_BACKEND_LOCATION = ENV_TOKENS.get('DISCUSSION_IMAGE_BACKEND_LOCATION', None)
DISCUSSION_ENABLE_WAF_PROXY = ENV_TOKENS.get('DISCUSSION_ENABLE_WAF_PROXY', False)
DISCUSSION_WAF_PROXY_SERVER_IP = ENV_TOKENS.get('DISCUSSION_WAF_PROXY_SERVER_IP', None)
DISCUSSION_WAF_PROXY_SERVER_PORT = ENV_TOKENS.get('DISCUSSION_WAF_PROXY_SERVER_PORT', None)
DISCUSSION_WAF_VIRUS_DETECTION_KEYWORD = ENV_TOKENS.get('DISCUSSION_WAF_VIRUS_DETECTION_KEYWORD', '')
DISCUSSION_ALLOWED_UPLOAD_FILE_TYPES = ENV_TOKENS.get('DISCUSSION_ALLOWED_UPLOAD_FILE_TYPES', [])
DISCUSSION_ALLOWED_IMAGE_MIME_TYPES = ENV_TOKENS.get('DISCUSSION_ALLOWED_IMAGE_MIME_TYPES', [])
...
ANONYMOUS_ID_SECRET_KEY = AUTH_TOKENS.get('ANONYMOUS_ID_SECRET_KEY', SECRET_KEY)
USERNAME_CIPHER_SECRET_KEY = AUTH_TOKENS.get('USERNAME_CIPHER_SECRET_KEY', SECRET_KEY)
...
if FEATURES.get('ENABLE_THIRD_PARTY_AUTH'):
    ...
    # We can get only the specified fields in Facebook
...
##### JWPLAYER XBLOCK #####
JWPLAYER_KEY = AUTH_TOKENS.get('JWPLAYER_KEY')
if FEATURES.get('ENABLE_JWPLAYER_SECURE_TOKEN'):
    JWPLAYER_SHARED_SECRET = AUTH_TOKENS.get('JWPLAYER_SHARED_SECRET', JWPLAYER_SHARED_SECRET)
    JWPLAYER_SECURE_TOKEN_EXPIRE = ENV_TOKENS.get('JWPLAYER_SECURE_TOKEN_EXPIRE', JWPLAYER_SECURE_TOKEN_EXPIRE)

##### RateLimitBackend #####
RATE_LIMIT_REQUESTS = ENV_TOKENS.get('RATE_LIMIT_REQUESTS', RATE_LIMIT_REQUESTS)
...
COURSE_TERMINATED_CHECK_EXCLUDE_PATH = ENV_TOKENS.get('COURSE_TERMINATED_CHECK_EXCLUDE_PATH', COURSE_TERMINATED_CHECK_EXCLUDE_PATH)

COURSEWARE_UNIT_LIMIT_DISPLAY_TEXT = ENV_TOKENS.get('COURSEWARE_UNIT_LIMIT_DISPLAY_TEXT', COURSEWARE_UNIT_LIMIT_DISPLAY_TEXT)

##### Settings for Biz #####
from biz.envs.aws import *

##### Settings for Mongo #####
PLAYBACK_FINISH_MONGO = AUTH_TOKENS.get('PLAYBACK_FINISH_MONGO', None)
...
GA_OPERATION_EMAIL_SENDER = ENV_TOKENS.get('GA_OPERATION_EMAIL_SENDER', None)
GA_OPERATION_VALID_DOMAINS_LIST = ENV_TOKENS.get('GA_OPERATION_VALID_DOMAINS_LIST', [])
GA_OPERATION_STD_ERR = ENV_TOKENS.get('GA_OPERATION_STD_ERR', None)
GA_OPERATION_STD_OUT = ENV_TOKENS.get('GA_OPERATION_STD_OUT', None)
GA_OPERATION_MONGO = AUTH_TOKENS.get('GA_OPERATION_MONGO', None)
GA_OPERATION_WORK_DIR = ENV_TOKENS.get('GA_OPERATION_WORK_DIR', '/tmp')
GA_OPERATION_ANALYZE_UPLOAD_BUCKET_NAME = ENV_TOKENS.get('GA_OPERATION_ANALYZE_UPLOAD_BUCKET_NAME', None)
GA_OPERATION_ANALYZE_UPLOAD_PREFIX = ENV_TOKENS.get('GA_OPERATION_ANALYZE_UPLOAD_PREFIX', None)
GA_OPERATION_SPECIFIC_COMPANY_KEYS = ENV_TOKENS.get('GA_OPERATION_SPECIFIC_COMPANY_KEYS', None)
GA_OPERATION_CALLBACK_EMAIL = ENV_TOKENS.get('GA_OPERATION_CALLBACK_EMAIL', None)
