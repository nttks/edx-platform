...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Optout.force_disabled'
        db.add_column('bulk_email_optout', 'force_disabled',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Optout.force_disabled'
        db.delete_column('bulk_email_optout', 'force_disabled')
