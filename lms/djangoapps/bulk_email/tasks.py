...
from student.roles import CourseStaffRole, CourseInstructorRole, GaCourseScorerRole, CourseBetaTesterRole
...
def _get_recipient_querysets(user_id, to_option, course_id):
    ...
    if to_option == SEND_TO_MYSELF:
        ...
        # Note: Add beta_tester. (#2478)
        beta_tester_qset = CourseBetaTesterRole(course_id).users_with_role()
        staff_instructor_qset = (staff_qset | instructor_qset | ga_course_scorer_qset | beta_tester_qset).distinct()
