...
class AdvancedCourseStatusTest(ModuleStoreTestCase):
    ...
    def test_has_available_f2f_course_full(self):
        ...
        self.assertTrue(AdvancedCourseStatus(self.client, course.id).has_available_f2f_course())
        ...
        # Verify unavailable
        self.assertFalse(AdvancedCourseStatus(self.client, course.id).has_available_f2f_course())
    ...
    def test_is_purchased(self):
        ...
        self.assertFalse(AdvancedCourseStatus(self.client, course.id).is_purchased())
        self.assertFalse(AdvancedCourseStatus(self.client, course.id).is_purchased(self.advanced_course_1.id))
        self.assertFalse(AdvancedCourseStatus(self.client, course.id).is_purchased(self.advanced_course_2.id))

        # Purchase
        purchase_ticket(self.client.user, self.advanced_course_tickets_1[0])

        # Verify purchased
        self.assertTrue(AdvancedCourseStatus(self.client, course.id).is_purchased())
        self.assertTrue(AdvancedCourseStatus(self.client, course.id).is_purchased(self.advanced_course_1.id))
        self.assertFalse(AdvancedCourseStatus(self.client, course.id).is_purchased(self.advanced_course_2.id))

        with self.assertRaises(ValueError):
            self.assertTrue(AdvancedCourseStatus(self.client, course.id).is_purchased(self.advanced_course_3.id))
    ...
    def test_get_purchased_orders(self):
        ...
        self.assertEqual([], AdvancedCourseStatus(self.client, course.id).get_purchased_orders())
        ...
        self.assertEqual([order1], AdvancedCourseStatus(self.client, course.id).get_purchased_orders())
        ...
        self.assertEqual([order1, order2], AdvancedCourseStatus(self.client, course.id).get_purchased_orders())
