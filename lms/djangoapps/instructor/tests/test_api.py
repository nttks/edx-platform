...
from student.models import (
    CourseEnrollment, CourseEnrollmentAllowed, NonExistentCourseError, UserStanding,
...
@attr('shard_1')
@ddt.ddt
class TestEndpointHttpMethods(ModuleStoreTestCase, LoginEnrollmentTestCase):
    """
...
class TestInstructorAPISurveyDownload(InstructorAPISurveyDownloadTestMixin, ModuleStoreTestCase, LoginEnrollmentTestCase):
    """
