...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (56, 7, 13),
        ('no_overrides', 2, True, False): (143, 7, 84),
        ('no_overrides', 3, True, False): (488, 7, 335),
        ('ccx', 1, True, False): (56, 7, 13),
        ('ccx', 2, True, False): (143, 7, 84),
        ('ccx', 3, True, False): (488, 7, 335),
        ('ccx', 1, True, True): (55, 7, 13),
        ('ccx', 2, True, True): (142, 7, 84),
        ('ccx', 3, True, True): (489, 7, 335),
        ('no_overrides', 1, False, False): (56, 7, 13),
        ('no_overrides', 2, False, False): (143, 7, 84),
        ('no_overrides', 3, False, False): (488, 7, 335),
        ('ccx', 1, False, False): (56, 7, 13),
        ('ccx', 2, False, False): (143, 7, 84),
        ('ccx', 3, False, False): (488, 7, 335),
        ('ccx', 1, False, True): (55, 7, 13),
        ('ccx', 2, False, True): (142, 7, 84),
        ('ccx', 3, False, True): (488, 7, 335),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (56, 4, 9),
        ('no_overrides', 2, True, False): (143, 19, 54),
        ('no_overrides', 3, True, False): (488, 84, 215),
        ('ccx', 1, True, False): (56, 4, 9),
        ('ccx', 2, True, False): (143, 19, 54),
        ('ccx', 3, True, False): (488, 84, 215),
        ('ccx', 1, True, True): (58, 4, 13),
        ('ccx', 2, True, True): (145, 19, 84),
        ('ccx', 3, True, True): (490, 84, 335),
        ('no_overrides', 1, False, False): (56, 4, 9),
        ('no_overrides', 2, False, False): (143, 19, 54),
        ('no_overrides', 3, False, False): (488, 84, 215),
        ('ccx', 1, False, False): (56, 4, 9),
        ('ccx', 2, False, False): (143, 19, 54),
        ('ccx', 3, False, False): (488, 84, 215),
        ('ccx', 1, False, True): (55, 4, 9),
        ('ccx', 2, False, True): (143, 19, 54),
        ('ccx', 3, False, True): (489, 84, 215),
    }
