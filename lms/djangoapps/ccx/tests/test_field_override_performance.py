...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (53, 7, 13),
        ('no_overrides', 2, True, False): (140, 7, 84),
        ('no_overrides', 3, True, False): (485, 7, 335),
        ('ccx', 1, True, False): (53, 7, 13),
        ('ccx', 2, True, False): (140, 7, 84),
        ('ccx', 3, True, False): (485, 7, 335),
        ('ccx', 1, True, True): (53, 7, 13),
        ('ccx', 2, True, True): (140, 7, 84),
        ('ccx', 3, True, True): (487, 7, 335),
        ('no_overrides', 1, False, False): (53, 7, 13),
        ('no_overrides', 2, False, False): (140, 7, 84),
        ('no_overrides', 3, False, False): (485, 7, 335),
        ('ccx', 1, False, False): (53, 7, 13),
        ('ccx', 2, False, False): (140, 7, 84),
        ('ccx', 3, False, False): (485, 7, 335),
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (53, 4, 9),
        ('no_overrides', 2, True, False): (140, 19, 54),
        ('no_overrides', 3, True, False): (485, 84, 215),
        ('ccx', 1, True, False): (53, 4, 9),
        ('ccx', 2, True, False): (140, 19, 54),
        ('ccx', 3, True, False): (485, 84, 215),
        ('ccx', 1, True, True): (55, 4, 13),
        ('ccx', 2, True, True): (142, 19, 84),
        ('ccx', 3, True, True): (487, 84, 335),
        ('no_overrides', 1, False, False): (53, 4, 9),
        ('no_overrides', 2, False, False): (140, 19, 54),
        ('no_overrides', 3, False, False): (485, 84, 215),
        ('ccx', 1, False, False): (53, 4, 9),
        ('ccx', 2, False, False): (140, 19, 54),
        ('ccx', 3, False, False): (485, 84, 215),
        ('ccx', 1, False, True): (53, 4, 9),
        ('ccx', 2, False, True): (140, 19, 54),
