...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (49, 6, 13),
        ('no_overrides', 2, True, False): (136, 6, 84),
        ('no_overrides', 3, True, False): (481, 6, 335),
        ('ccx', 1, True, False): (49, 6, 13),
        ('ccx', 2, True, False): (136, 6, 84),
        ('ccx', 3, True, False): (481, 6, 335),
        ('ccx', 1, True, True): (49, 6, 13),
        ('ccx', 2, True, True): (136, 6, 84),
        ('ccx', 3, True, True): (481, 6, 335),
        ('no_overrides', 1, False, False): (49, 6, 13),
        ('no_overrides', 2, False, False): (136, 6, 84),
        ('no_overrides', 3, False, False): (481, 6, 335),
        ('ccx', 1, False, False): (49, 6, 13),
        ('ccx', 2, False, False): (136, 6, 84),
        ('ccx', 3, False, False): (481, 6, 335),
        ('ccx', 1, False, True): (49, 6, 13),
        ('ccx', 2, False, True): (136, 6, 84),
        ('ccx', 3, False, True): (481, 6, 335),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (49, 4, 9),
        ('no_overrides', 2, True, False): (136, 19, 54),
        ('no_overrides', 3, True, False): (481, 84, 215),
        ('ccx', 1, True, False): (49, 4, 9),
        ('ccx', 2, True, False): (136, 19, 54),
        ('ccx', 3, True, False): (481, 84, 215),
        ('ccx', 1, True, True): (51, 4, 13),
        ('ccx', 2, True, True): (138, 19, 84),
        ('ccx', 3, True, True): (483, 84, 335),
        ('no_overrides', 1, False, False): (49, 4, 9),
        ('no_overrides', 2, False, False): (136, 19, 54),
        ('no_overrides', 3, False, False): (481, 84, 215),
        ('ccx', 1, False, False): (49, 4, 9),
        ('ccx', 2, False, False): (136, 19, 54),
        ('ccx', 3, False, False): (481, 84, 215),
        ('ccx', 1, False, True): (49, 4, 9),
        ('ccx', 2, False, True): (136, 19, 54),
        ('ccx', 3, False, True): (481, 84, 215),
    }
