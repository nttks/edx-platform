...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (52, 7, 13),
        ('no_overrides', 2, True, False): (139, 7, 84),
        ('no_overrides', 3, True, False): (484, 7, 335),
        ('ccx', 1, True, False): (52, 7, 13),
        ('ccx', 2, True, False): (139, 7, 84),
        ...
        ('ccx', 1, False, False): (52, 7, 13),
        ('ccx', 2, False, False): (139, 7, 84),
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (52, 4, 9),
        ('no_overrides', 2, True, False): (139, 19, 54),
        ('no_overrides', 3, True, False): (484, 84, 215),
        ('ccx', 1, True, False): (52, 4, 9),
        ('ccx', 2, True, False): (139, 19, 54),
        ('ccx', 3, True, False): (484, 84, 215),
        ('ccx', 1, True, True): (54, 4, 13),
        ('ccx', 2, True, True): (141, 19, 84),
        ('ccx', 3, True, True): (486, 84, 335),
        ('no_overrides', 1, False, False): (52, 4, 9),
        ('no_overrides', 2, False, False): (139, 19, 54),
        ('no_overrides', 3, False, False): (484, 84, 215),
        ('ccx', 1, False, False): (52, 4, 9),
        ('ccx', 2, False, False): (139, 19, 54),
