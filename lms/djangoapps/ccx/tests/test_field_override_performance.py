...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True): (28, 7, 14),
        ('no_overrides', 2, True): (136, 7, 85),
        ('no_overrides', 3, True): (596, 7, 336),
        ('ccx', 1, True): (28, 7, 14),
        ('ccx', 2, True): (136, 7, 85),
        ('ccx', 3, True): (596, 7, 336),
        ('no_overrides', 1, False): (28, 7, 14),
        ('no_overrides', 2, False): (136, 7, 85),
        ('no_overrides', 3, False): (596, 7, 336),
        ('ccx', 1, False): (28, 7, 14),
        ('ccx', 2, False): (136, 7, 85),
        ('ccx', 3, False): (596, 7, 336),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True): (28, 4, 9),
        ('no_overrides', 2, True): (136, 19, 54),
        ('no_overrides', 3, True): (596, 84, 215),
        ('ccx', 1, True): (28, 4, 9),
        ('ccx', 2, True): (136, 19, 54),
        ('ccx', 3, True): (596, 84, 215),
        ('no_overrides', 1, False): (28, 4, 9),
        ('no_overrides', 2, False): (136, 19, 54),
        ('no_overrides', 3, False): (596, 84, 215),
        ('ccx', 1, False): (28, 4, 9),
        ('ccx', 2, False): (136, 19, 54),
        ('ccx', 3, False): (596, 84, 215),
    }
