...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (54, 7, 13),
        ('no_overrides', 2, True, False): (141, 7, 84),
        ('no_overrides', 3, True, False): (486, 7, 335),
        ('ccx', 1, True, False): (54, 7, 13),
        ('ccx', 2, True, False): (141, 7, 84),
        ('ccx', 3, True, False): (486, 7, 335),
        ('ccx', 1, True, True): (53, 7, 13),
        ('ccx', 2, True, True): (140, 7, 84),
        ('ccx', 3, True, True): (487, 7, 335),
        ('no_overrides', 1, False, False): (54, 7, 13),
        ('no_overrides', 2, False, False): (141, 7, 84),
        ('no_overrides', 3, False, False): (486, 7, 335),
        ('ccx', 1, False, False): (54, 7, 13),
        ('ccx', 2, False, False): (141, 7, 84),
        ('ccx', 3, False, False): (486, 7, 335),
        ('ccx', 1, False, True): (53, 7, 13),
        ('ccx', 2, False, True): (140, 7, 84),
        ('ccx', 3, False, True): (486, 7, 335),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (54, 4, 9),
        ('no_overrides', 2, True, False): (141, 19, 54),
        ('no_overrides', 3, True, False): (486, 84, 215),
        ('ccx', 1, True, False): (54, 4, 9),
        ('ccx', 2, True, False): (141, 19, 54),
        ('ccx', 3, True, False): (486, 84, 215),
        ('ccx', 1, True, True): (56, 4, 13),
        ('ccx', 2, True, True): (143, 19, 84),
        ('ccx', 3, True, True): (488, 84, 335),
        ('no_overrides', 1, False, False): (54, 4, 9),
        ('no_overrides', 2, False, False): (141, 19, 54),
        ('no_overrides', 3, False, False): (486, 84, 215),
        ('ccx', 1, False, False): (54, 4, 9),
        ('ccx', 2, False, False): (141, 19, 54),
        ('ccx', 3, False, False): (486, 84, 215),
        ('ccx', 1, False, True): (53, 4, 9),
        ('ccx', 2, False, True): (141, 19, 54),
        ('ccx', 3, False, True): (487, 84, 215),
    }
