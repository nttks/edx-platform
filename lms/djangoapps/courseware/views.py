...
def _attendance(request, course_key):
    ...
    display_status = executor.get_attendance_status_str(start=course.start, end=course.end,
                                                        terminate_date=course.terminate_start,
                                                        self_paced=course.self_paced, course_id=course.id,
