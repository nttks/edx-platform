...
class AttendanceStatusExecutorTests(ModuleStoreTestCase, PlaybackFinishTestBase):
    ...
    def test_get_attendance_status_str_when_previous(self):
        ...
        status = executor.get_attendance_status_str(
            start=self.course.start, end=self.course.end, terminate_date=self.course.terminate_start,
            self_paced=self.course.self_paced, course_id=self.course.id,
    ...
    def test_get_attendance_status_str_when_self_paced_is_true_and_closing(self):
        ...
        self.course.terminate_start = '2001-01-01 00:00:00'
        self.course.save()
        CourseEnrollmentAttributeFactory.create(
            enrollment=self.enrollment, namespace='ga', name='attended_status', value='{"attended_date": "test"}')
        self.course.is_status_managed = True
    ...
    def test_get_attendance_status_str_when_self_paced_is_true_and_working(self):
        # arrange
        self.course.self_paced = True
        self.course.terminate_start = '2001-05-01 00:00:00'
        self.course.save()
        CourseEnrollmentAttributeFactory.create(
            enrollment=self.enrollment, namespace='ga', name='attended_status', value='{"attended_date": "test"}')
        self.course.is_status_managed = True
    ...
    def _setup_course_modules(self):
        ...
        course
          ...
          |   |  |- vertical_x13
          |   |  |    |- module_x13_html_survey1
          |   |  |- vertical_x14
          |   |  |    |- module_x14_html_survey1
          |   |  |- vertical_x15
          |   |  |    |- module_x15_html_survey1
          |   |  |- vertical_x16
        ...
        self.module_x13_html_survey1 = ItemFactory.create(
            category='html', parent_location=self.vertical_x13.location, display_name='module_x13_html_survey1',
            metadata={'is_status_managed': True})
        # vertical_x14
        self.vertical_x14 = ItemFactory.create(parent=self.section_x1, category='vertical', display_name="vertical_x14")
        self.module_x14_html_survey1 = ItemFactory.create(
            category='html', parent_location=self.vertical_x14.location, display_name='module_x14_html_survey1',
            metadata={'is_status_managed': True})
        # vertical_x15
        self.vertical_x15 = ItemFactory.create(parent=self.section_x1, category='vertical', display_name="vertical_x15")
        self.module_x15_html_survey1 = ItemFactory.create(
            category='html', parent_location=self.vertical_x15.location, display_name='module_x15_html_survey1',
            metadata={'is_status_managed': False})
        # vertical_x16
    ...
    def test_check_attendance_status_when_not_attended_html_survey(self):
        # arrange
        self._setup_course_modules()
        StudentModuleFactory.create(
            course_id=self.course.id, module_state_key=self.module_x11_problem1.location, student=self.user,
    ...
    def test_check_attendance_status_when_not_attended_freetextresponse(self):
        # arrange
        self._setup_course_modules()
        StudentModuleFactory.create(
            course_id=self.course.id, module_state_key=self.module_x11_problem1.location, student=self.user,
    ...
    def test_update_attendance_status(self):
        ...
        CourseEnrollmentAttributeFactory.create(
            enrollment=self.enrollment, namespace='ga', name='attended_status',
            value='{"attended_date": "2019-01-01T10:00:00.000000"}')
        # act
        AttendanceStatusExecutor.update_attendance_status(course=self.course, user_id=self.user.id)
        # assert
        self.assertTrue(
