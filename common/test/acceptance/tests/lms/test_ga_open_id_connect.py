...
from lms.envs.bok_choy import OAUTH_OIDC_ISSUER, EDXMKTG_COOKIE_NAME
...
class AuthorizeTest(UniqueCourseTest, GaccoTestMixin):
    ...
    def _access_authorize_page(self, response_type, client_id, redirect_uri, scope, state, nonce):
        ...
        if self.browser.get_cookie(EDXMKTG_COOKIE_NAME) is None:
    ...
    def _assert_access_token(self, scope, token_response):
        ...
        id_token = jwt.decode(token_response['id_token'], self.client_secret)
