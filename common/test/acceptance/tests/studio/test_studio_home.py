...
from ...pages.studio.library import LibraryHomePage


class CreateLibraryTest(StudioLibraryTest):
    """
    ...
    def setUp(self):
        ...
        self.libhome_page = LibraryHomePage(self.browser, self.course_fixture._course_key)
    ...
    def test_create_library(self):
        ...
        self.libhome_page.visit()
        self.assertTrue(self.libhome_page.has_new_library_button())

        self.libhome_page.click_new_library()
        self.assertTrue(self.libhome_page.is_new_library_form_visible())
        self.libhome_page.fill_new_library_form(name, number)
        self.assertTrue(self.libhome_page.is_new_library_form_valid())
        self.libhome_page.submit_new_library_form()

        # The next page is the library edit view; make sure it loads:
        lib_page = LibraryEditPage(self.browser, LibraryLocator(self.course_fixture._course_dict['org'], number), self.course_fixture._course_key)
